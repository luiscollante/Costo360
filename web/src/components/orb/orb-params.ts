...
export const ORB_IDLE: OrbUniformParams = {
  ...
  warp: ORB_THINKING.warp * 0.6,
  ridgeAmt: ORB_THINKING.ridgeAmt * 0.55,
  sharp: ORB_THINKING.sharp * 0.9,
  shade: ORB_THINKING.shade,
  // Antes ×0.68 — se veía casi negro a tamaño pequeño (hallazgo real del
  // fundador, 2026-09-16). En reposo debe distinguirse menos que "thinking",
  // pero nunca leerse como "no hay nada ahí".
  exposure: ORB_THINKING.exposure * 0.92,
  edgeGlow: ORB_THINKING.edgeGlow,
  colorA: '#D9C283',
  colorB: '#5C9270',
  colorC: '#B49A57',
  colorD: '#3D6650',
  highlightColor: '#E7DEC2',
  glowColor: '#B49A57',
}
