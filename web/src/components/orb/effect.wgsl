// Copiado verbatim de github.com/LerSent001/orb (MIT License,
// Copyright (c) 2026 LerSent001) — ver LICENSE_ORB.md en esta misma carpeta.
// Sin modificar; la personalización de marca de Costo360 vive en
// `orb-params.ts` (colores) y `CostOrb.tsx` (integración en React), nunca
// en este archivo.
//
