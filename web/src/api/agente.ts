...
// La Bóveda (bitácora de acciones de Cost, Ciclo 3) ya NO tiene pantalla de
// usuario ni endpoints REST propios — es memoria interna que el modelo
// consulta bajo demanda vía tools (`agente_bitacora_consultar`,
// `agente_bitacora_deshacer`), nunca desde el frontend directamente.
