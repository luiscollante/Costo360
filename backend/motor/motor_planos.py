...
def _generar_svg_nesting(
    ...
    # ════════════════════════════════════════════════════════════════════════
    # Rect 1: fondo lámina (dark stone)
    parts.append(
    ...
    if unplaced:
        ...
        parts.append(
            ...
            f'rx="4" fill="#180808" stroke="#5A2020" stroke-width="1.2"/>'
            f'<text x="{ox+10:.1f}" y="{_yp+14:.1f}" '
            f'font-family="Helvetica,Arial,sans-serif" font-size="10" '
            f'font-weight="bold" fill="#E05050">&#9888; No caben en esta placa:</text>'
            f'<text x="{ox+10:.1f}" y="{_yp+30:.1f}" '
            f'font-family="Helvetica,Arial,sans-serif" font-size="9" '
            f'fill="#A03030">{_esc(_nombres_u)}</text>'
        )
    ...
    for idx, p in enumerate(placed):
        ...
        # Casilla □ — dark with light border (print-friendly)
        parts.append(
