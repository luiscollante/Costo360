...
# Costo360 · Sistema de Cotización para Mármoles Collante & Castro
...
TOUR_PASOS = [
    {
        "id":       "bienvenida",
        "etiqueta": "COSTOMARMOL",
        "icono":    "⚡",
        "titulo":   "Sistema de Cotizacion Profesional",
        "cuerpo":   "Bienvenido a Costo360. Este sistema te permite calcular el costo real de cualquier proyecto en piedra natural o sinterizado y generar cotizaciones PDF listas para enviar al cliente.\n\nEl recorrido guiado cubre las funciones clave en menos de 2 minutos.",
        "pagina":   None,
    },
    {
