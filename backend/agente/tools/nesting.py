...
registrar(ToolSpec(
    ...
    declaracion=gtypes.FunctionDeclaration(
        ...
        description=(
            ...
            "empaquetado y devuelve el % de aprovechamiento, cuántas piezas cupieron y "
            "cuáles NO cupieron. Es un cálculo puro y efímero — no guarda nada en la "
            "base de datos, no crea ningún registro, se puede llamar tantas veces como "
            "el usuario quiera probar combinaciones distintas. El plano visual se "
            "muestra directamente en la página de Nesting; nunca intentes describir ni "
            "repetir el dibujo en tu respuesta de texto, solo las métricas. Si al "
            "usuario le falta dar una dimensión de la lámina o de alguna pieza, dile "
            "explícitamente qué falta — nunca asumas un valor."
        ),
        parameters={
            "type": "OBJECT",
            "properties": {
